...
class BaseNet(nn.Module):
    def __init__(self):
        ...
        # self.layer1[0].relu = nn.ReLU(inplace=False)
        # self.layer1[1].relu = nn.ReLU(inplace=False)
        # self.layer2[0].relu = nn.ReLU(inplace=False)
        # self.layer2[1].relu = nn.ReLU(inplace=False)
        # self.layer3[0].relu = nn.ReLU(inplace=False)
        # self.layer3[1].relu = nn.ReLU(inplace=False)
        # self.layer4[0].relu = nn.ReLU(inplace=False)
        # self.layer4[1].relu = nn.ReLU(inplace=False)
